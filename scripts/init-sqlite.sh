#!/bin/bash
# SQLite initialization script for Payments Service
# This script is executed when the SQLite container is first created

set -e

echo "Initializing SQLite database for Payments Service..."
...
INSERT OR IGNORE INTO database_metadata (key, value) VALUES ('initialized', 'Payments Service');
